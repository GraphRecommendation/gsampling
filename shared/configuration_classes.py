...
class ExperimentConfiguration(ConfigurationBase):
    def __init__(self, name: str, dataset: DatasetConfiguration, experiment: ExperimentEnum, folds: int = 5,
        ...
        :param test_size: size of the test set - only used if folds == 1. and experiment is stratified.
        ...
        self.folds = folds if self.experiment == ExperimentEnum.WARM_START else 1
