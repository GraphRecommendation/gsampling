...
class INMORecommender(RecommenderBase):
    ...
    def _fit(self, validator: Validator, first_epoch, final_epoch=1000, trial=None):
        ...
        neg_sampler = UniformRecommendableItemSampler(1, g.edges(etype='ui'), methodology=self.sampling_method)
    ...
    def set_parameters(self, parameters):
        ...
        self.sampling_method = parameters.get('sampling_method', 'non-rated')
