...
from datasets.partitioners import warm_start, temporal_splitting
...
def run(in_path, experiment_name):
    ...
    elif experiment.experiment == ExperimentEnum.TEMPORAL:
        folds = temporal_splitting.fold_data_iterator
    else:
